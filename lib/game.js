...
const PRESET_RULE_TYPES = consts.PRESET_RULE_TYPES;
...
class Game {
  ...
  constructor(options) {
    options = Object.assign({
      presetRuleType: PRESET_RULE_TYPES.STANDARD,
    }, options || {});

    let boardOptions = pick(options, 'rowIndex', 'colIndex', 'mapText');
    if (options.presetRuleType === PRESET_RULE_TYPES.STANDARD) {
      boardOptions = {
        mapText: [
          '--------',
          '--------',
